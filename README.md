# Control-Citas-jsp
El repositorio contiene el proyecto web realizado en JSP para la vacante de Quileia; el proyecto esta conectado a un servidor local Glassfish y una base de datos relacional en MySQL
