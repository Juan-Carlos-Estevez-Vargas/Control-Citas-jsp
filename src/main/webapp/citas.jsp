...
<html>
    ...
    <body>
        ...
        <jsp:include page="/WEB-INF/paginas/citas/comunes/botonesNavegacion.jsp" />

        <!-- Listado Clientes -->
        <jsp:include page="WEB-INF/paginas/citas/listadoCitas.jsp" />

        <!-- Pie de página o footer -->
        <jsp:include page="/WEB-INF/paginas/citas/comunes/piePagina.jsp" />
